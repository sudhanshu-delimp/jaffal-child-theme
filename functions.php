...
include_once get_stylesheet_directory().'/assets/class/class-custom.php';
...
function load_external_jQuery() { 
    ...
    $sbs_obj = new Custom();
    wp_localize_script( 'developer_custom_yith_wcan_shortcodes_script', 'yith_wcan_shortcodes', $sbs_obj->get_class_localization());
}  
